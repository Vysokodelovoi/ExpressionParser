...
public abstract class UnaryExpression<T> extends MyExpression<T> {
    protected final MyExpression<T> subExpression;

    public UnaryExpression(MyExpression<T> subExpression) {
